...
public class LineSumitoBlockedMoveTest implements TestConfig {
    ...
    public void executeTest(Board board) {
        System.out.println("――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――");
        System.out.println("Test mouvement en ligne avec sumito bloqué par une bille de sa couleur: erreur attendue \n");
