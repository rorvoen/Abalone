...
public class ArrowSumitoInvalidMoveTest implements TestConfig {
    public void setupTestConfig(Board board) {
        ...
        board.getBoardSquares()[5][2].setContent(SquareContent.WHITE);
    }
    ...
    public void executeTest(Board board) {
        System.out.println("――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――");
        System.out.println("Test mouvement en fléche avec sumito impossible : erreur attendue \n");
