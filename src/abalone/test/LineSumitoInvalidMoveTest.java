...
public class LineSumitoInvalidMoveTest implements TestConfig {
    public void setupTestConfig(Board board) {
        ...
        board.getBoardSquares()[5][2].setContent(SquareContent.BLACK);
        board.getBoardSquares()[5][3].setContent(SquareContent.BLACK);
        board.getBoardSquares()[5][4].setContent(SquareContent.WHITE);
        board.getBoardSquares()[5][5].setContent(SquareContent.WHITE);
        board.getBoardSquares()[5][6].setContent(SquareContent.WHITE);
    }
    ...
    public void setupTestMove(Board board, Player player1, Player player2){
        ...
        try {
            ...
            testMove.addMarbleToMove(board.getBoardSquares()[5][2],player1);
            testMove.addMarbleToMove(board.getBoardSquares()[5][3],player1);
    ...
    public void executeTest(Board board) {
        System.out.println("――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――");
        System.out.println("Test mouvement en ligne avec sumito impossible : erreur attendue \n");
