...
public class ArrowSumitoBlockedMoveTest implements TestConfig {
    public void setupTestConfig(Board board) {
        ...
        board.getBoardSquares()[3][4].setContent(SquareContent.WHITE);
        board.getBoardSquares()[4][3].setContent(SquareContent.WHITE);
        board.getBoardSquares()[4][4].setContent(SquareContent.BLACK);
    }
    ...
    public void executeTest(Board board) {
        System.out.println("――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――");
        System.out.println("Test mouvement en fléche avec sumito bloqué par une bille de sa couleur: erreur attendue \n");
